...
if ( $tab_title_match === 'yes' || !empty( $wcpoa_checkout_all_ids ) || !empty( $wcpoa_order_attachment_items ) && isset( $wcpoa_order_attachment_items['wcpoa_attachment_ids'] ) && is_array( $wcpoa_order_attachment_items['wcpoa_attachment_ids'] ) && !empty( array_filter( $wcpoa_order_attachment_items['wcpoa_attachment_ids'] ) ) ) {
    if ( !empty( $sitepress ) ) {
